 ...
 */
public class ExtendableBronKerboschCliqueFinder<V, E> {


    private final Graph<V, E> graph;

    protected Collection<Set<V>> cliques;
     ...
     *              simple
     */
    public ExtendableBronKerboschCliqueFinder(Graph<V, E> graph) {
        this.graph = graph;
    }
        ...
        if (!end(candidates, already_found)) {
            ...
            for (V candidate : candidates_array) {
                ...
                if (new_candidates.isEmpty() && new_already_found.isEmpty()) {
                    ...
                    final HashSet<V> c = new HashSet<>(potential_clique);
                    cliques.add(c);
                    nextCliqueFound(c);
                } // of if
                else {
    ...
    protected void nextCliqueFound(Set<V> clique) {
        // does nothing
    }
