...
Jak dotąd nie zostały opublikowane teoretyczne ograniczenia dla złożoności algorytmu Brona-Kerboscha\citep{tomita}. Empiryczne rezultaty z naszy testów zostały zamieszczone w sprawozdaniu\ref{fig:time-complexity}
