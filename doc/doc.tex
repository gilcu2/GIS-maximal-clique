...
\begin{itemize}
  ...
  \item cykl ma maksymalną klikę o wielkości 1
...
Aby uruchomić testy należy wykonać \textit{sbt test} w głównym katalogu programu. Pełna lista spełnianych asercji została umieszczona w sprawozdaniu \ref{fig:tests}.
